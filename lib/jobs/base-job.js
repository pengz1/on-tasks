...
function baseJobFactory(
    ...
    /**
     * @function _subscribeUcsCommand
     * @description subscribe and wait for a request from the ucs command exchange.
     **/
    BaseJob.prototype._subscribeUcsCommand = function(uuid, callback) {
        var self = this;
        var deferred = messenger.subscribe(
            Constants.Protocol.Exchages.Task.Name,
